...
const Home = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const slicedProduct = response.data.products.slice(0, 6);
  ...
  return (
    <div className="p-20 mx-auto flex items-center flex-col">
      <h1 className="text-3xl font-bold text-indigo-900"> Home Page</h1>
      ...
      <button
        className="w-1/2 p-3 text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg mt-5 font-bold"
